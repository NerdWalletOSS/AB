/* TL1 */
drop table if exists dw_workarea.rst_ab_tl1
;

create table dw_workarea.rst_ab_tl1 as
...
drop table if exists dw_workarea.rst_ab_ramp_times
;

create table dw_workarea.rst_ab_ramp_times as
...
drop table if exists dw_workarea.rst_ab_valid_user
;

create table dw_workarea.rst_ab_valid_user as
select a.test_id
, a.ramp
, a.variant_id
, a.user_id
, a.entry_ts
, b.end_time
from dw_workarea.rst_ab_tl1 a
join
dw_workarea.rst_ab_ramp_times b
on a.test_id = b.test_id and a.ramp = b.ramp
and a.entry_ts >= b.start_time
and a.entry_ts <= b.end_time
;

drop table if exists dw_workarea.rst_ab_user_page_view
;

create table dw_workarea.rst_ab_user_page_view as
select v.test_id
, v.ramp
, v.variant_id 
, v.user_id
, p.pv_id
from
dw_workarea.rst_ab_valid_user v
join
...
drop table if exists dw_workarea.rst_ab_user_pv_count
;

create table dw_workarea.rst_ab_user_pv_count as
select test_id, ramp, variant_id, user_id, count(*) as num_pages
from dw_workarea.rst_ab_user_page_view
group by test_id, ramp, variant_id, user_id
;

drop table if exists dw_workarea.rst_ab_numpvs_user_count
;

create table dw_workarea.rst_ab_numpvs_user_count as
select test_id, ramp, variant_id, num_pages, count(user_id) as num_users
from dw_workarea.rst_ab_user_pv_count
group by test_id, ramp, variant_id, num_pages
;

drop table if exists dw_workarea.rst_ab_desc_stats
;

create table dw_workarea.rst_ab_desc_stats as
...
drop table if exists dw_workarea.rst_ab_z_p_stats
;

create table dw_workarea.rst_ab_z_p_stats as
select tst.*
...
from
dw_workarea.rst_ab_desc_stats tst
join
(select * from dw_workarea.rst_ab_desc_stats
