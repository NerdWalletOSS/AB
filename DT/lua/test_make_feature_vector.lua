...
describe("Testing make_feature_vector", function()

  require "DT/dt"
  hard_code_config()
  update_config()

  it("should be able to return the correct make_feature_vector for test data.", function()

    local X = {
      {
        json_file = "mk_fvec_body1.json",
        n_fvec = 57
      }
    }
