...
\begin{tabular}{|l||l|l|l|l|l|l|l|l|}  \hline \hline
  ...
  20 & Test2 & Started & {\tt Edit, Terminate, Archive} & 
  Section~\ref{edit_test}, ~\ref{stop_test} ~\ref{archive_test} \\ \hline 
...
\label{start_test}
Changes state to start and returns to home page Section~\ref{home_page}
...
Changes state to archived and returns to home page Section~\ref{home_page}
