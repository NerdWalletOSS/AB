...
assert(postal_cd_features, 'postal_cd_features not loaded')
...
describe("Testing postal_cd_to_vars", function()
	...
	it("should be able to give out valid outputs to 100 good randomly
		generated inputs (postal code as numeric)", function()
		for i=1,1000 do
	...
	it("should be able to give out valid outputs to 100 good randomly
		generated inputs (postal code as string)", function()
		for i=1,1000 do
	...
	it("should be able to fail when 100 randomly generated invalid
		inputs are provided", function()
		for i=1,1000 do
